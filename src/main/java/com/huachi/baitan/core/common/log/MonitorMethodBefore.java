...
/**
 * 类MonitorLogMethodBefore的实现描述：记录方法的入参，使用注解： {@link}
 * <p>
...
@Aspect
@MonitorMethodAdvice
public class MonitorMethodBefore extends AbstractMonitorLog {
     ...
     * <code>@com.zhongan.flying.shark.log.annotation.LogMethodBefore</code>
     * </ul>
     */
    @Pointcut("@within(com.huachi.baitan.core.common.log.annotation.LogMethodBefore)"// 放在class上有效，method上无效
            + " || @annotation(com.huachi.baitan.core.common.log.annotation.LogMethodBefore)" // 放在class上无效，method上有效
    )
